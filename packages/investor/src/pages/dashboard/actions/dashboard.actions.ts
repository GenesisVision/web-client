...
export const fetchDashboardFunds = (auth: Nullable<string>, filters: any) => {
  return {
...
export const fetchPortfolioChart = (auth: Nullable<string>, filters?: any) => {
  return {
...
export const fetchPortfolioEvents = (auth: Nullable<string>, filters: any) => {
  return {
...
export const cancelProgramRequest = (auth: Nullable<string>, id: string) => {
  return {
...
export const fetchDashboardTradesHistory = (
  auth: Nullable<string>,
  filters: any
) => {
  return {
