...
const ProgramUnfollowForm = React.memo(
  compose<React.ComponentType<OwnProps>>(
    translate(),
...
const modes: { [key: string]: mode } = {
  none: { label: "Manual closing", value: "None" },
  closeOnly: { label: "Close only", value: "ProviderCloseOnly" },
  closeAll: { label: "Close all immediately", value: "CloseAllImmediately" }
};
