...
import { fundChartDataLoaderData, fundStatisticDataLoaderData } from "../fund-details.loader-data";
...
import { useChartPeriod, useFundChartStateValues } from "./fund-details-chart-section/fund-details-chart.helpers";
import FundProfitChart from "./fund-details-chart-section/fund-profit-chart-section/fund-profit-chart";
import FundDetailsStatisticsElements, { IFundStatisticData } from "./fund-details-statistics/fund-details-statistics-elements";
