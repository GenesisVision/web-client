import { durationPeriod, formatDate, localizedDate } from "./dates";
...
describe("test dates functions", () => {
  ...
  it("should format period into string", () => {
    const period1 = durationPeriod(
      "2019-10-03T21:33:10.9392540+00:00",
      "2019-10-09T09:59:25.7601750+00:00"
    );
    const period2 = durationPeriod(
      "2019-10-09T09:59:25.7601750+00:00",
      "2020-01-06T09:59:25.7601750+00:00"
    );
    const period3 = durationPeriod(
      "2019-08-27T07:13:46.0872100+00:00",
      "2019-10-03T21:33:10.9392540+00:00"
    );
    const period4 = durationPeriod(
      "2019-08-20T14:45:24.6779810+00:00",
      "2019-08-27T07:13:46.0872100+00:00"
    );
    const period5 = durationPeriod(
      "2019-09-05T09:50:35.4116020+00:00",
      "2019-09-05T15:15:52.8617580+00:00"
    );
    const period6 = durationPeriod(
      "2019-09-05T15:16:53.5976620+00:00",
      "2019-09-05T15:21:51.5987380+00:00"
    );

    expect(period2).toBe("2 months 28 days");
    expect(period3).toBe("1 month 6 days");
    expect(period4).toBe("6 days 16 hours");
    expect(period1).toBe("5 days 12 hours");
