    ...
    guides: [
        ...
        content: (
          <>
            <p>
              ...
              Programs, Funds don’t require active participation from a manager
              necessarily. The profit in GV Funds is achieved from the organic
              price growth of assets included in the Fund, and not by trading
              activities of the manager.
            </p>

            <h3>How do I invest in a Fund?</h3>
            <p>
              Investing in a GV Fund is very simple. Once you have chosen a Fund
              that suits your strategy, click the “Invest” button. You can
              invest in a GV Fund with any currency in your wallet. When you
              invest in a GV Fund, your investment is accepted instantaneously.
            ...
            <p>
              ...
              <b>purchase all the underlying assets included within it</b>. The
              profit is received from the <b>organic price growth</b> of the
              assets in the Fund. Once the price of the assets goes up, so does
              the price of your share (or unit). When an investor withdraws
              their investment, all their funds held within the Fund are{" "}
              <b>sold</b>, and the resulting balance is withdrawn to their
            ...
            <p>
              ...
              stays there till the investor decides to withdraw it, no exit fee
            ...
            <p>
              ...
              impossible to calculate the exact investors’ share upon the time
              of withdrawal. This is due to all the underlying commissions and
        ...
        content: (
          <>
            <p>
              ...
              fees and the duration of the reporting period (up to a maximum of
              90 days) along with other parameters. He will have the opportunity
              to trade cryptocurrency or Forex markets with a view to earn
              profits for himself and investors that may wish to join him on
            ...
            <p>
              ...
              <b>beginning of the reporting period</b>. Simply click the{" "}
              <b>"Invest"</b> button on the page of the desired investment{" "}
              <b>Program</b> that you want to use. A trader may opt to end their
              reporting period manually for many reasons. This is at the
              complete discretion of the trader.
              <br />
              You can cancel your <b>investment request</b> unless it’s already
              processed. This can be done from the dashboard section, or
              directly on the program page their requests for investing in a
              selected <b>Program</b>.
            </p>
            ...
            <ol>
              <li>
                <b>GV commission</b>: is the fee charged by the platform that is
                a percentage of the initial amount invested in a Program.
              </li>
              <li>
                ...
                as a percentage of the profit received from a Program during the
                reporting period or from a trade transaction when copy trading.
                We do not charge a Success Fee if there were no profits made.
              </li>
              <li>
                <b>Management fee</b>: The commission that is paid to the
                manager by an investor for the actual asset management period.
                Management fee is defined in annual percentage and is charged at
              ...
              <li>
                ...
                as a percentage of the profit received from a Program during the
                reporting period. No profit means no Success fee is charged.
              </li>
              <li>
            ...
            <p>
              *This percentage depends on the amount of GVT stored in the
              ...
              10%. For every 1 000 GVT stored in the wallet reduces the success
              fee by 1% (i.e. an investor holding 1 000 GVT will only pay a 9%
              Success Fee, an investor holding 10 000 GVT and more will pay no
              Success Fees).
            </p>

            <h3>Stop Out</h3>
            <p>
              The manager sets Stop out level when creating a program. It can be
              from <b>10 - 100%</b> and can only be changed downward. A stop out
              is a compulsory closing of positions at current market prices when
              a loss reaches the stop out level to <b>protect investors</b>.
            </p>
            <p>
            ...
            <ul>
              <li>
                ...
                is reinvested in the Program keeping all configured conditions.
              </li>
              <li>
                “Ignore SO” is turned <b>OFF </b> your investment (minus losses)
            ...
            <p>
              ...
              the reporting period will be reinvested into the same Program. If
              you have, reinvesting <b>turned off</b>, all profits are{" "}
            ...
            <p>
              To withdraw funds, you need to send a request. It could be done on
              the Program page, button <b>“Withdraw”</b>. Your withdrawal
            ...
            <ul>
              ...
              <li>
                Your investment gets accepted at the beginning of each reporting
                period.
              </li>
              <li>
                You need to pass KYC to be able to invest more than 1000 USD in
                total.
              </li>
              <li>
                If the “available to invest” amount in the Program is 0, you can
                hit the “Notify me” button and get a notification when it is
                possible to invest in this Program again.
              </li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              Genesis Vision now offers a unique opportunity to follow external
              trades from <b>Binance</b>.
            </p>
            ...
            <ol>
              ...
              <li>
                ...
                <b>through API</b>. It could be done in the overview section on
                your GV Dashboard. The instructions on how to create an API are{" "}
                <a
                ...
                . Important: to follow a trader with your Binance account create
                an API key <b>with the trading rights</b>.
                <ConversationImages
                  size={"large"}
                  images={[
                    {
              ...
              <li>
                Press the <b>“Follow trades” button</b> on the trader’s page. It
                will offer you to choose an existing External account of yours
                or to attach a new External account.
              </li>

              <li>
                Choose the type of subscription (read about the types of
                subscription below) and a tolerance percentage (maximum possible
                deviation of the trade price from 0% to 20%).
                <ConversationImages
                  size={"large"}
                  images={[
                    {
            ...
            <ul>
              ...
              <li>
                ...
                Provider has opened a trade for 100 GVTBTC while the percentage
                the Subscriber has set is 30%, it will open the trade on the
                Subscriber trade account for 30 GVTBTC.
              </li>
              <li>
                <b>Fixed</b>. By choosing this subscription type, the positions
                will open only for the fixed amount that the Subscriber has set
                in the USD equivalent field when subscribing to the signal
                program/trading account. It does not depend on the size of the
                trade of the provider.
              </li>
            </ul>
            ...
            <ol>
              ...
              <li>
                ...
                transaction when Copy Trading. It is calculated according to the{" "}
                <a
                  href="https://www.investopedia.com/terms/h/highwatermark.asp"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                as a percentage of the profit received from a trade transaction
                when copy trading. No profit means no Success fee is charged.
              </li>
              <li>
                <b>Platform Success fee</b> is the fee charged on any profits
                ...
                as a percentage of the profit from a trade transaction when copy
                trading.
              </li>
              <li>
            ...
            <p>
              * This percentage depends on the amount of GVT stored in the
              ...
              10%. For every 1 000 GVT stored in the wallet reduces the success
              fee by 1% (i.e. an investor holding 1 000 GVT will only pay a 9%
              Success Fee, an investor holding 10 000 GVT will pay no Success
              Fees).
            </p>
            ...
            <p>
              ...
              but all the opened trades stay open. The Subscriber can close the
              open trades manually at any time. This means when the Provider
              closes their trades they will not be closed on the Subscribers
              trading account.
            </p>
            ...
            <ul>
              <li>
                You can always close a trade by yourself regardless of the type
                of subscription. To do that you need login to your Binance
                account and sell this coin.
              </li>
              <li>
              ...
              <li>
                If the calculated lot volume is less than the minimum lot volume
                for this symbol on Binance, then the Subscriber deal will not
                open either.
              </li>
              <li>
              ...
              <li>
                You can only use the copy trading functionality if you are a GVT
                holder. To subscribe to the trading signals of a manager, an
                investor needs to have GVT. Signal fees are withdrawn from the
                GVT wallet.
              </li>
              <li>
