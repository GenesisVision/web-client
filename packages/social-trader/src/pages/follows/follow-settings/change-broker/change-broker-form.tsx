...
const _ChangeBrokerForm: React.FC<Props> = ({
  ...
  return (
    <form id="change-broker-form" onSubmit={handleSubmit}>
      <div className="follow-settings__block-wrapper--broker-list">
        {brokers.map(broker => (
          <BrokerCard
            logo={broker.logo}
            key={broker.name}
      ...
      />
      <p className="follow-settings__text follow-settings__text--padding-top">
        {t("follow-settings.broker.text-change")}
      </p>
      <GVButton
      ...
      >
        {t("follow-settings.buttons.change-broker")}
      </GVButton>
      <ConfirmChangeBroker
...
export const HuobiWarning: React.FC<IHuobiWarningProps> = ({
  ...
  return from === "Genesis Markets" && to === "Huobi" && isSignalProgram ? (
    <p className="follow-settings__text follow-settings__text--color-accent follow-settings__text--padding-top">
      {t("follow-settings.broker.text-warning")}
    </p>
  ) : null;
};
