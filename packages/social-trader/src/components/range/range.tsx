  ...
  return (
    <>
      <style jsx global>{`
        ...
        .range .rc-slider-track:hover {
          border-color: ${$primaryColor};
        }
        .range .rc-slider-track:active,
        .range .rc-slider-track:focus {
          border-color: ${$primaryColor};
          box-shadow: 0 0 5px ${$primaryColor};
        }
        .range .rc-slider-dot-active {
          border-color: ${$primaryColor};
        }
        ...
        .calculator-slider__slider-element .rc-slider-rail {
          height: 1px;
          background-color: rgba(255, 255, 255, 0.1);
          margin-top: 1px;
        }

        .calculator-slider__slider-element .rc-slider-dot {
          display: none;
        }

        .calculator-slider__slider-element .rc-slider-handle {
        ...
        .calculator-slider__slider-element .rc-slider-handle:hover {
          border-color: ${$primaryColor};
          box-shadow: 0 0 5px ${$primaryColor};
        }

        .calculator-slider__slider-element .rc-slider-handle:active,
        .calculator-slider__slider-element .rc-slider-handle:focus {
          border-color: ${$primaryColor};
          background-color: ${$popoverBackground};
          box-shadow: 0 0 5px ${$primaryColor};
        }

        .calculator-slider__slider-element .rc-slider-mark-text,
