...
export const adaptiveMargin = (direction: string, marginSize: string) => {
  return css`
    margin-${direction}: ${marginSize}/${$dividerPadding};
    ${mediaBreakpointLandscapePhone(`margin-${direction}: ${marginSize};`)}
  `;
};
