    ...
    <section className="glossary-section">
      ...
      <div className="internal__content">
        <article className="internal__article">
          ...
          <p>
            <b>Period</b> (Reporting Period) - is a period which is pre-defined
            by the manager; at the end of which all trading positions are closed
            with a subsequent distribution of the profit, investors are then
            either disconnected from the Program or connected to it, additional
            investment amounts are made and the commission is paid to the
            manager.
          </p>
          <p>
          ...
          <p>
            <b>Drawdown</b> (D.down) - the peak-to-trough decline of a program
            or a fund, this is usually quoted as the percentage between the peak
          ...
          <p>
            <b>Reinvest</b> - an option available to investors that allows them
            to reinvest their profits back into the original program they
            invested in.
          </p>
          <p>
            <b>Available to invest</b> - the amount available for investment up
            to the next period.
          </p>
          <p>
        ...
        <article className="internal__article">
          <h2>Statistics</h2>
          <p>
            <b>Trades</b> - the number of trades the manager has performed
            during the selected date range.
          </p>
          <p>
            <b>Success trades</b> - the percentage of successful trades among
            the number of total trades during the selected date range.
          </p>
          <p>
          ...
          <p>
            <b>Sortino ratio</b> - the Sortino ratio is a variation of the
            Sharpe ratio that only factors in the downside risk.
          </p>
          <p>
          ...
          <p>
            <b>Maximum drawdown</b> - the biggest drawdown of a program or a
            fund during the selected date range.
          </p>
          <p>
        ...
        <article className="internal__article">
          ...
          <p>
            <b>Direction (Dir)</b> - (Sell or Buy) - an indicator showing a
            trade direction.
          </p>
          <p>
          ...
          <p>
            <b>Ticket</b> - a unique id number assigned to each opened position
            or pending order in the trading terminal.
          </p>
          <p>
            <b>Entry</b> - (in or out) - this is the current status of the
            trade. If the trade has got a status “in”, it means that the trade
            is still open. If the trade has got a status “out”, it means that
        ...
        <article className="internal__article">
          <h2>Funds</h2>
          <p>
            <b>GV Fund</b> - GV Funds are portfolios of multiple assets,
            gathered and chosen by the manager. The profit in GV Funds is
            achieved from the organic price growth of the chosen assets included
            within the fund, and not by “active trading activities” of the
            manager.
          </p>
          <p>
        ...
        <article className="internal__article">
          ...
          <p>
            <b>Available</b> - funds of the user that are currently available
            for investment.
          </p>
          <p>
          ...
          <p>
            <b>Withdrawal</b> - a transaction of taking funds out of the
            account.
          </p>
          <p>
        ...
        <article className="internal__article">
          ...
          <p>
            ...
            trader conducts trading operations on financial markets. The
            strategy defines the traders behaviour while they’re active on the
            market.
          </p>
          <p>
          ...
          <p>
            <b>Leverage</b> - the correlation between the margin amount and
            trade volume. For instance, leverage 1:100 means that in order to
            conduct the trading operation it is necessary to have an amount that
            is 100 times smaller than the transaction volume on a trading
            account.
          </p>
        </article>
      </div>
