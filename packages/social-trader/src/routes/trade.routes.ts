...
export const TERMINAL_SPOT_NAME = "spot";
export const TERMINAL_FUTURES_NAME = "futures";
export const TERMINAL_SPOT_ROUTE = `${TERMINAL_ROUTE}?type=${TERMINAL_SPOT_NAME}`;
export const TERMINAL_FUTURES_ROUTE = `${TERMINAL_ROUTE}?type=${TERMINAL_FUTURES_NAME}`;
