  ...
  ["ds-property-pages"],
  {
      ...
      inherit(o, l),
        ...
        (o.prototype._prepareSeriesStyleLayout = function(e, t, i, o) {
          ...
          this._isHiLoChartsAvailable() &&
            ...
            this.bindControl(
              new b(J, o.lineStyle.color, !0, this.model(), "Change Line Color")
            ),
            this.bindControl(
              new C(
                ee,
      ...
      inherit(o, n),
        (o.prototype.addLevelEditor = function(e, t, i) {
          ...
          b.appendTo(e),
            ...
            this.bindControl(
              new s(p, i.coeff, !1, this.model(), "Change Pitchfork Line Coeff")
            ),
    ...
    A3Hk: function(e, t, i) {
      function o() {
        ...
        return (
          $(
            '<option value="' + n.LeftToRight + '">' + $.t("Left") + "</option>"
          ).appendTo(e),
          $(
            '<option value="' +
              n.RightToLeft +
        ...
        (o.prototype.prepareLayout = function() {
          ...
          t.levels._childs))
            (a = t.levels[n]),
              ...
              this.bindControl(
                new s(u, a.color, !0, this.model(), "Change Gann Line Color", 0)
              ),
              this.bindControl(
      ...
      inherit(o, n),
        (o.prototype.addLevelEditor = function(e, t) {
          ...
          return (
            ...
            n.css("width", "70px"),
            this.bindControl(
              new l(n, e.coeff, !1, this.model(), "Change Pitchfork Line Coeff")
            ),
      ...
      inherit(o, n),
        (o.prototype.addLevelEditor = function(e, t, i) {
          ...
          _.appendTo(this._table),
            ...
            this.bindControl(
              new d(y, t.linewidth, !0, this.model(), "Change Fib Circle Width")
            );
        }),
        (o.prototype.prepareLayout = function() {
          var e, t, i, o, n, a, l;
