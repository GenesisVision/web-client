...
import InvestmentLimitField from "./fields/investment-limit-field";
...
const _InvestmentLimit: React.FC<Props> = ({
  ...
  return (
    <SettingsBlock
      label={t("manager.create-asset-page.settings.fields.investment-limit")}
      content={
        <form id="edit-form" onSubmit={handleSubmit}>
          ...
          <p className="asset-settings__text">
            {t("manager.asset-settings.investment-limit.text")}
          </p>
          <GVButton
            color="primary"
            type={"submit"}
        ...
        [FIELDS.investmentLimit]: mixed().when(FIELDS.hasInvestmentLimit, {
          ...
          then: number()
            .min(
              0,
              t(
                "manager.create-asset-page.settings.validation.investment-limit-min"
              )
            )
            .lessThan(
              10000000000,
            ...
            .required(
              t(
                "manager.create-asset-page.settings.validation.investment-limit-required"
              )
            )
        })
      }),
