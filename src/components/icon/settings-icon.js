...
export const SettingsIcon = props => {
  return (
    <Icon type={"settings"} {...props}>
      ...
      >
        <g opacity="1">
          <rect width="12" height="12" fill="black" fillOpacity="0" />
          <path
            ...
            strokeWidth="1.5"
          />
          <path d="M2.25 6H0" stroke="white" strokeWidth="1.5" />
          <path d="M12 6H9.75" stroke="white" strokeWidth="1.5" />
          <path d="M6 12V9.75" stroke="white" strokeWidth="1.5" />
          <path d="M6 2.25V0" stroke="white" strokeWidth="1.5" />
          <rect
            width="1.5"
            height="2.25"
            fill="black"
